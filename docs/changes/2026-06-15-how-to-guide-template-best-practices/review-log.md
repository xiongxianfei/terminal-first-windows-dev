# Review Log: How-To Guide Template Best Practices
...
- Governing artifacts: spec, test spec, plan, and spec review for how-to guide template best practices
- Validation evidence: targeted template proof script, commit whitespace checks, and M1 `rg` checks
...
M1 is closed. Next stage is `implement M2`. Final closeout remains not ready.
...
- Governing artifacts: spec, test spec, plan, and spec review for how-to guide template best practices
- Validation evidence: targeted guide/evidence proof script, M2 `rg` checks, and commit whitespace checks
...
- Governing artifacts: spec, test spec, plan, and constitution for how-to guide template best practices
- Validation evidence: targeted static proof script, AC14 proposal-status check, commit whitespace check, and M4 diff inspection
...
M4 is closed. Next stage is final closeout. Final verification and PR handoff have not run.
