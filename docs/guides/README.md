...
2. [Install or migrate WSL2 Ubuntu](02-wsl2-ubuntu.md)
...
The future sequence guide will be `fresh-setup.md`. Until that guide exists, the numbered files above are the compatibility path for the full setup order.
